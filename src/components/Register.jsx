...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    users.push({ ...formData, id: Date.now(), timestamp: new Date().toISOString() });
      ...
      <div className={styles.successContainer}>
        <div className={styles.successBox}>
          <div className={styles.successIcon}>
            <svg width="80" height="70" viewBox="0 0 24 24" fill="#4CAF50" margin-top="2rem">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
            </svg>
          </div>
          <h1 className={styles.successTitle}>Registration Successful!</h1>
          <p className={styles.successMessage}>
            Thank you, {formData.name}! Your account has been created successfully.
          </p>
          <a href="/" className={styles.primaryBtn}>Back to Home</a>
        </div>
      </div>
    );
  }
  ...
  return (
        ...
        <div className="container">
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroSubtitle}>
              Register now to participate in events and connect with our community.
            </p>
          </div>
        </div>
      </section>
    ...
    <div className={styles.registerWrapper}>
      ...
      <div className={styles.registerContainer}>
        ...
        <p className={styles.subtitle}>Register to participate in events and engage with the community.</p>
        ...
        <form onSubmit={handleSubmit} className={styles.registerForm}>
          ...
          <div className={styles.formGroup}>
            <label>Phone</label>
            <input type="text" name="phone" value={formData.phone} onChange={handleInputChange} placeholder="Optional phone number" />
          ...
          <div className={styles.formActions}>
            ...
            <button type="button" onClick={() => setFormData({name:'', email:'', password:'', confirmPassword:'', phone:''})} className={styles.secondaryBtn}>Clear Form</button>
          </div>
        </form>
      </div>
